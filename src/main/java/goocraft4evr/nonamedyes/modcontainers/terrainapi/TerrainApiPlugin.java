...
public class TerrainApiPlugin implements TerrainAPI {
    ...
    public void onInitialize() {
		...
		ChunkDecoratorOverworldAPI.oreFeatures.addFeature(new WorldFeatureOre(ModBlocks.oreMalachiteStone.id, 6, true), 2, 1/4f);
		...
		ChunkDecoratorOverworldAPI.randomFeatures.addFeature(new WorldFeatureFlowers(ModBlocks.flowerIndigo.id), 6, 1, 1,
