...
public class TerrainAPIPlugin implements TerrainAPI {
    ...
    public void onInitialize() {
		...
		overworldConfig.addTreeDensity(ModBiomes.OVERWORLD_PALM_BEACH, 1);
		...
		ChunkDecoratorNetherAPI.randomFeatures.addFeature(new WorldFeatureLake(Block.fluidWaterStill.id), 4, 1, 1,
			new Biome[]{ModBiomes.OVERWORLD_PALM_BEACH});
		ChunkDecoratorOverworldAPI.randomFeatures.addFeature(new WorldFeatureSpinifexPatch(), 12, -1, 5,
			new Biome[]{Biomes.OVERWORLD_DESERT, ModBiomes.OVERWORLD_PALM_BEACH});
